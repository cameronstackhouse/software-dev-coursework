...
public class BagTest {
    ...
    public void testGetPebbles(){
        ...
        pebbles = bag.getPebbles();

        for(int i = 0; i < pebbles.size(); i++){
            assertEquals(1, pebbles.get(i).getWeight());
            assertEquals(0, pebbles.get(i).getBagIndex());
        }
    }
    ...
    @Test
    public void testIsEmptyEmptyBag(){
        bag.setPebbles(new ArrayList<>());
